...
import Address, {
    AddressInterface,
} from '../../../src/database/model/address.model';
...
describe('address.repository', () => {
    ...
    describe('Given I have an address repository', () => {
        test('it should save an address', async () => {
            expect(await repository.create(address)).toEqual(
        ...
        test('it should update an address', async () => {
            ...
            expect(await repository.update(address)).toBeTruthy();
        });

        test('it should delete an address', async () => {
            expect(await repository.delete(address._id)).toBeTruthy();
        });
    });
});
